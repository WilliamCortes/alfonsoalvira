...
const About: React.FC = () => {
  const personSchema = {
    ...
    "jobTitle": "Sobandero Tradicional y Terapeuta de Columna",
    "image": `https://alfonsoalvira.vendo365.com${alfonsoProfile}`,
    "description": "Don Alfonso Alvira es un sobandero con 43 años de experiencia en Villavicencio, Meta, especializado en terapias manuales de columna y cuajo.",
          ...
          <div className="flex flex-col lg:flex-row gap-12 items-center">
            ...
            <div className="flex-1">
              <div className="relative rounded-2xl overflow-hidden shadow-xl aspect-[3/4] max-w-md mx-auto">
                <img 
                  src={alfonso} 
                  alt="Don Alfonso Alvira Yasno - Sobandero en Villavicencio" 
                  className="w-full h-full object-cover"
                />
                <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent"></div>
                <div className="absolute bottom-6 left-6 text-white">
                  <h1 className="font-serif text-2xl font-bold">Alfonso Alvira Yasno</h1>
                  <p className="text-white/90 font-medium">Sobandero Tradicional en el Meta</p>
                </div>
              </div>
            </div>
            ...
            <div className="flex-1 space-y-6">
              ...
              <div className="space-y-4 text-gray-700 leading-relaxed text-lg">
                <p>
                  Soy <strong>Don Alfonso Alvira</strong>, conocido en Villavicencio y gran parte del Meta por mi labor como <strong>sobandero tradicional</strong>. Durante más de 43 años, he perfeccionado el arte de la terapia manual empírica.
                </p>
                <p>
